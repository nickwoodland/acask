...
<div class="show-for-large-up" data-equalizer>
    <nav class="header" data-topbar role="navigation">
        <section class="row collapse landmark">
            <div class="columns medium-4 header--leftcol" data-equalizer-watch>
                <?php if("" != $tel && false != $tel): ?>
                    <span><strong>T: </strong><a href="tel:<?php echo $tel; ?>"><?php echo $tel; ?></a></span>
                <?php endif; ?>
            </div>
            <div class="name columns medium-4 text-center" data-equalizer-watch>
                <h1><a href="<?php echo home_url(); ?>" class="logo"><?php bloginfo( 'name' ); ?></a></h1>
            </div>
            <div class="columns medium-4 header--rightcol" data-equalizer-watch>
