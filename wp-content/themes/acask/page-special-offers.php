...
<div class="pad-wrapper">
	...
	<div class="row">
		...
		<div class="small-12 columns negative-offest-left" role="main">
			...
			<?php $offers = get_post_meta( $post->ID, '_offers_products_group', false ); ?>


			 <?php // $offer_ids = array_values($offers); ?>

			 <?php $offer_ids = array(); ?>

			 <?php foreach($offers as $offer): ?>
			 	<?php $offer_ids[] = $offer['_offers_product_select']; ?>
			 <?php endforeach; ?>

			<?php if(!empty($offer_ids)) : ?>
				<?php $offers_args = array(
					'post_type' => 'product',
					'posts_per_page' => 12,
					'post__in' => $offer_ids,
				);

				$offer_posts = new WP_Query($offers_args);
				$wp_query = $offer_posts;
